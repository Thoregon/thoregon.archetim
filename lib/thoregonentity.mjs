...
const ThoregonEntity = (base) => class ThoregonEntity extends (base || Object) {
    ...
    static async initiate(props) {
        // get class for schema and instantiate
        const instance = new this();
        // decorate the object
        const entity = await instance.initiate(props);
    ...
    /**
     * initiate an object which become persistent when it is assigned
     * to a property of a ThoregonEntity (persistent object)
     * @param props
     * @return {Promise<void>}
     */
    async initiate(props) {
        ...
        // decorate the object
        const entity = universe.ThoregonDecorator.observe(this, { encrypt, decrypt });
        return entity;
    }
