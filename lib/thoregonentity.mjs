...
export class ThoregonObject extends ThoregonEntity() {
            ...
            if (attribute.includes(':')) {
                ...
                if (source.includes('()')) {
                    ...
                    if (targetObject && typeof targetObject[functionName] === 'function') {
                        const value = targetObject[functionName]();
                        ThoregonObject.setNestedProperty(snapshot, destination.split('.'), value);
                    }
                } else {
                ...
                if (value !== undefined) {
                    ThoregonObject.setNestedProperty(snapshot, attribute.split('.'), value);
                }
            }
        });
    ...
    static setNestedProperty(obj, keys, value) {
        let current = obj;
