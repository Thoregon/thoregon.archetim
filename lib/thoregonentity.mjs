...
const ThoregonEntity = (base) => class ThoregonEntity extends (base || Object) {
     ...
     * @returns {Promise<*>}
     */
    static async materialize(props, { store } = {}) {
        const instance = new this();
        const entity = await instance.materialize(props,{ store });
        return entity;
    }
    ...
    static async create(props, { store } = {}) {
        // get class for schema and instantiate
        const instance = new this();
        const entity = await instance.create(props, { store });
        return entity;
    }
    ...
    async materialize(props, { store } = {}) {
        const { encrypt, decrypt } = await this.getCrypto();
        Object.assign(this, props);

        const entity = universe.ThoregonDecorator.observe(this, { store, encrypt, decrypt });
