...
const ThoregonEntity = (base) => class ThoregonEntity extends (base || Object) {
    ...
    static async create(props, { store, inmem = false, neglectmeta = false } = {}) {
        // get class for schema and instantiate
        // if missing create an object
        const instance = new this(props);
        // decorate the object
        const entity = await instance.create({ store, inmem, neglectmeta });
...
*/
    ...
    async create({ store, inmem = false, neglectmeta = false } = {}) {
        // todo [OPEN]:
        ...
        decrypt.pub = '1234567890';
        // decorate the object
        const entity = ThoregonDecorator.observe(this, { store, encrypt, decrypt, inmem, neglectmeta });
