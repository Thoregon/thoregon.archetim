...
export const isAsyncIterable = (obj) => obj != null && typeof obj[Symbol.iterator] === 'function';
...
export const canReference    = (obj) => !isFunction(obj) && !(obj instanceof WebAssembly) && !(obj instanceof WeakSet) && !(obj instanceof WeakRef) && !(obj instanceof DataView);    // reject also SharedArrayBuffer, Generator, GeneratorFunction; also Proxies but this cannot be checked
