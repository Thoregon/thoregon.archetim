        ...
        Object.entries(amfrom).forEach(([prop, value]) => {
            ...
            if (isNil(value)) {
                ...
                if (!this.__checkReferenceConflict__(prop, amfrom, totarget, currref, currval, value)) {
                    ...
                    // debugger;
                    console.log("$$ TD check merge!", currref, otherref);
//                    if (currval) this.__mergeReferences__(prop, totarget, currref, currval, value); // there was an entity, need to merge with other
                }
                ...
                // just use all other values.
                Reflect.set(totarget, prop, value);
...
*/
    ...
    __merge__(parenthandler, to, other, prop) {
        ...
        Reflect.set(to, prop, this.proxy$);
