...
export default class ThoregonDecorator extends AccessObserver {
     ...
     */
    static observe(target, { props, parent, soul, handle, create, Cls, typeRef, metaClass, encrypt, decrypt, amdoc, withDeleted, tombstone, incommingSync = false, load = false, readonly = false } = {}) {
        if (target == undefined) return undefined;
        const proxy = super.observe(target, { props, parent, soul, handle, create, Cls, typeRef, metaClass, encrypt, decrypt, amdoc, withDeleted, tombstone, load, readonly });
