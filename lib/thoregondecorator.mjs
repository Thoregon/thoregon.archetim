 ...
 *
 * todo [OPEN]
 *  - introduce a lifecycle state machine for each persistent object
...
export default class ThoregonDecorator extends Reporter(AccessObserver) {
    ...
    get hasattributeMode$() {
        return this.metaClass$.attributeMode !== ATTRIBUTE_MODE.NAMED;
    }
