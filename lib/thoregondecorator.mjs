...
export default class ThoregonDecorator extends AccessObserver {
    ...
    static __restore__(soul, { Cls, typeRef, handle, metaClass, encrypt, decrypt, withDelete, tombstone, incommingSync = false } = {}) {
        ...
        if (!serentity) {
            ...
            ({ obj, refs, handle, Cls, meta } = this.__deserializeDecorator__(serentity));
        }
    ...
    static __deserializeDecorator__(serentity) {
        const { soul, obj, refs, meta, Cls } = persistancedeserialize(serentity);
