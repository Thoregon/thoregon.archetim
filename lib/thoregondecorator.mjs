...
*/
    ...
    async modifiedEntry(item, key) {
        ...
        if (entry) {
            ...
            if (!dels.is_empty) this.emit('change', { property: '*', properties: dels, obj: this.proxy$, type: 'del' });
            if (!mods.is_empty) this.emit('change', { property: '*', properties: mods, obj: this.proxy$, type: 'set' });
