...
export default class AnnotationParser {
    ...
    async analyze(Cls, meta, origin) {
        ...
        this.resolveAnnotation(clsprefixannotations, Cls, undefined, meta, origin, source, cls);
        this.resolveAnnotation(clspostfixannotations, Cls, undefined, meta, origin, source, cls);
    ...
    getMethodAnnotations(Cls, meta, origin, clssrc, source) {
        ...
        names.forEach((name) => {
            ...
            const mth = {};
            if (!prefix.is_empty)
            this.resolveAnnotation(prefix, Cls, name, meta, origin, source, mth);
            this.resolveAnnotation(postfix, Cls, name, meta, origin, source, mth);
    ...
    resolveAnnotation(annotations, Cls, mthname, meta, origin, source, obj) {
