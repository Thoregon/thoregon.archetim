...
*/
    ...
    text( name, options= {} )  {
        return this.addAttribute(MetaClass.text());
    }
    ...
    derived(name, type, options= {} )  {
        ...
        let attribute = new AttributeDerived();
        return this.addAttribute( this.fillAttribute( attribute,  name, properties) );
    }
    ...
    // embedded types, use for derived attributes
...
export class AttributeDerived    extends Attribute {}
