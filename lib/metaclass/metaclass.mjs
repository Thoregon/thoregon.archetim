...
export const VARIABLE_ATTRIBUTE_MODE = {
    "NONE"    : 0,
    "ASIS"    : 1,
    "ENCRYPT" : 2,
}
...
export default class MetaClass {
    ...
    constructor() {
        ...
        this.embedded           = false;
        this.variableAttributes = VARIABLE_ATTRIBUTE_MODE.NONE;
    ...
    static any(obj) {
        ...
        metaclass.variableAttributes = VARIABLE_ATTRIBUTE_MODE.ENCRYPT;
        return metaclass;
    }
    ...
    getAttribute(name) {
        return this.attributes[name] ?? (this.variableAttributes !== VARIABLE_ATTRIBUTE_MODE.NONE ? ARBITRARY_ATTRIBUTE : undefined);
    }
    /**
