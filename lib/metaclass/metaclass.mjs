...
*/
    ...
    static collection( name, cls ,options= {} )  {
        let properties = { embedded: false, autocomplete: true, itemclass: undefined, cls, ...options };
...
class AttributeComplex extends Attribute {
    ...
    adjustEntity(value, currentValue) {
        ...
        if (this.cls == undefined || this.cls === Object) return;                     // if there is a Class defined for this property create an Instance with the value's properties
        const Cls = this.cls;
